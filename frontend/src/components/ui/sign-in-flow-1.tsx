                ...
                {step === "email" ? (
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white font-heading">Welcome Creator</h1>
                    ...
                    <p className="text-sm text-white/50 pt-10">
                      Don&apos;t have an account? <Link href="/signup" className="underline text-white hover:text-white/80 transition-colors">Sign up as creator</Link>
                    </p>
                  </motion.div>
                ) : step === "password" ? (
                  <motion.div 
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white font-heading">
                        {loading ? "Verifying..." : "Enter password"}
                      </h1>
                      <p className="text-[1.25rem] text-white/50 font-light">
                        {loading ? "Checking your credentials" : "Secure login to your account"}
                      </p>
                    </div>
                    ...
                    <form onSubmit={handlePasswordSubmit} className="space-y-4">
                      ...
                      <div className="flex w-full gap-3 pt-2">
                        <motion.button 
                          ...
                          disabled={loading}
                          className="rounded-full bg-white text-black font-medium px-8 py-3 hover:bg-white/90 transition-colors w-[30%] cursor-pointer border-none"
                    ...
                    <div className="pt-16">
                      <p className="text-xs text-white/40">
                        Don't have an account? <Link href="/signup" className="underline text-white/40 hover:text-white/60 transition-colors">Sign up</Link>
                      </p>
                    </div>
                  </motion.div>
                ) : (
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white font-heading">You're in!</h1>
