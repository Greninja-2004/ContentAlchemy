    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="mt-4 text-2xl font-bold text-slate-900 dark:text-zinc-50">Create your account</h1>
          <p className="mt-1 text-sm text-slate-500 dark:text-zinc-400">Start generating content for free</p>
        </div>
        ...
        >
          <div>
            <Label htmlFor="name" className="text-sm font-medium text-slate-700 dark:text-zinc-350">Name</Label>
            <Input
              id="name"
              type="text"
              value={name}
        ...
        <p className="mt-6 text-center text-sm text-slate-500 dark:text-zinc-400">
          ...
          <Link href="/login" className="text-indigo-600 dark:text-indigo-400 font-semibold hover:text-indigo-800 dark:hover:text-indigo-300 transition-colors">
            Sign in
          </Link>
        </p>
      </motion.div>
